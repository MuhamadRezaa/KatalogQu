...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This section defines how the package identifies the current tenant.
    |
    | You can enable multiple identification methods. The first one that
    | successfully identifies a tenant will be used.
    |
    */
