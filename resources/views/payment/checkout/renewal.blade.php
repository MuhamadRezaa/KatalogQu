            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="mt-6 pt-4 border-t">
                        <h3 class="font-medium mb-3">Fitur Paket:</h3>
                        <ul id="package-features" class="list-disc list-inside text-sm text-gray-600 space-y-1">
                            @if ($currentTemplate->features)
                                @foreach (json_decode($currentTemplate->features) as $feature)
                                    <li>{{ $feature }}</li>
                                @endforeach
                            @else
                                <li>Fitur tidak tersedia.</li>
                            @endif
                        </ul>
                    </div>
                </div>
