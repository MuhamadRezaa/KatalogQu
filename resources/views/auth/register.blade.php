        ...
        <div class="register-card">
            ...
            @if(session('google_user'))
                ...
                <form action="{{ route('google.register') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-google w-100 mb-4">
                        <i class="fab fa-google"></i>
                        <span>Daftarkan Akun dengan Google</span>
                    </button>
                </form>
            ...
            <div class="text-center">
                <p class="mb-0">
                    Sudah punya akun? <a href="{{ route('login') }}" class="text-link">Masuk sekarang</a>
                </p>
            </div>
        </div>
    </div>
