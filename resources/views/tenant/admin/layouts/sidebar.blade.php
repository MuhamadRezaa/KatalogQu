        ...
        <div id="sidebar-menu">
            <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list">
                    ...
                    <a class="sidebar-link sidebar-title link-nav {{ request()->is('/kelola-toko/*/dashboard') ? 'active' : '' }}"
                ...
                <li class="sidebar-list">
                    <i class="fa fa-thumb-tack"></i>
                    <a class="sidebar-link sidebar-title link-nav {{ request()->is('*kelola-toko/*/categories*') ? 'active' : '' }}"
                ...
                @if (in_array('subkategoriproduk', $menus))
                    <li class="sidebar-list">
                        <i class="fa fa-thumb-tack"></i>
                        <a class="sidebar-link sidebar-title link-nav {{ request()->is('*kelola-toko/*/sub-categories*') ? 'active' : '' }}"
                ...
                @if (in_array('brandproduk', $menus))
                    <li class="sidebar-list">
                        <i class="fa fa-thumb-tack"></i>
                        <a class="sidebar-link sidebar-title link-nav {{ request()->is('*kelola-toko/*/brands*') ? 'active' : '' }}"
                ...
                @if (in_array('unitproduk', $menus))
                    <li class="sidebar-list">
                        <i class="fa fa-thumb-tack"></i>
                        <a class="sidebar-link sidebar-title link-nav {{ request()->is('*kelola-toko/*/product-units*') ? 'active' : '' }}"
                ...
                <li class="sidebar-list">
                    <i class="fa fa-thumb-tack"></i>
                    <a class="sidebar-link sidebar-title link-nav {{ request()->is('*kelola-toko/*/products*') ? 'active' : '' }}"
                ...
                <li class="sidebar-list">
                    <i class="fa fa-thumb-tack"></i>
                    <a class="sidebar-link sidebar-title link-nav {{ request()->is('*kelola-toko/*/price-ranges*') ? 'active' : '' }}"
                ...
                <li class="sidebar-list">
                    <i class="fa fa-thumb-tack"></i>
                    <a class="sidebar-link sidebar-title link-nav {{ request()->is('*kelola-toko/*/store-heroes*') ? 'active' : '' }}"
                ...
                <li class="sidebar-list">
                    <i class="fa fa-thumb-tack"></i>
                    <a class="sidebar-link sidebar-title link-nav {{ request()->is('*kelola-toko/*/settings') ? 'active' : '' }}"
