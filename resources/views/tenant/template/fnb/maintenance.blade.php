...
<body class="min-h-screen bg-gradient-to-br from-green-50 to-blue-100 flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="bg-green-500 p-6 text-center">
            <div class="flex justify-center mb-4">
                <div class="bg-white p-3 rounded-full">
                    <i data-lucide="settings" class="h-12 w-12 text-green-500"></i>
                </div>
            </div>
        ...
        <div class="p-8 text-center">
            ...
            <p class="text-gray-600 mb-6">
                We're currently preparing delicious meals and beverages for you. Please check back soon!
            </p>

            <div class="bg-blue-50 rounded-lg p-4 mb-6">
                <p class="text-blue-800 font-medium">
                    {{ $store->maintenance_message ?? 'Our team is working hard to bring you an improved dining experience.' }}
                </p>
            </div>
