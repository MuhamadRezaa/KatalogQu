(function ($) {
  ...
  $(document).ready(function () {
    $(".customizer-color li").on("click", function () {
      ...
      $("#color").attr("href", "/assets/riho-asset/css/" + color + ".css");
    ...
    $(".sidebar-type li").on("click", function () {
      ...
      switch (type) {
        ...
        case "normal-sidebar": {
          ...
          $(".logo-wrapper")
            .find("img")
            .attr("src", "/assets/riho-asset/images/logo/logo.png");
